...
# Template: subdirs
# Command: /usr/bin/qmake-qt5 -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile stableFluids.pro
#############################################################################
...
sub-solver_gpu-qmake_all:  FORCE
	...
	cd solver_gpu/ && $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd solver_gpu/ && $(MAKE) -f Makefile qmake_all
sub-solver_gpu: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-solver_gpu-make_first: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-solver_gpu-all: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-solver_gpu-clean: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-solver_gpu-distclean: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-solver_gpu-install_subtargets: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-solver_gpu-uninstall_subtargets: FORCE
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-solver_cpu-qmake_all:  FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd solver_cpu/ && $(MAKE) -f Makefile qmake_all
sub-solver_cpu: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-solver_cpu-make_first: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-solver_cpu-all: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-solver_cpu-clean: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-solver_cpu-distclean: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-solver_cpu-install_subtargets: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-solver_cpu-uninstall_subtargets: FORCE
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-application-qmake_all:  FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd application/ && $(MAKE) -f Makefile qmake_all
sub-application: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-application-make_first: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-application-all: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-application-clean: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-application-distclean: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-application-install_subtargets: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-application-uninstall_subtargets: FORCE
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall

Makefile: stableFluids.pro /usr/lib64/qt5/mkspecs/linux-clang/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		stableFluids.pro
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile stableFluids.pro
...
sub-solver_gpu-check:
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-solver_cpu-check:
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-application-check:
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
check: sub-solver_gpu-check sub-solver_cpu-check sub-application-check

sub-solver_gpu-benchmark:
	@test -d solver_gpu/ || mkdir -p solver_gpu/
	cd solver_gpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_gpu/solver_gpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile benchmark
sub-solver_cpu-benchmark:
	@test -d solver_cpu/ || mkdir -p solver_cpu/
	cd solver_cpu/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/solver_cpu/solver_cpu.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile benchmark
sub-application-benchmark:
	@test -d application/ || mkdir -p application/
	cd application/ && ( test -e Makefile || $(QMAKE) /home/alberto/stableFluids/application/application.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile benchmark
